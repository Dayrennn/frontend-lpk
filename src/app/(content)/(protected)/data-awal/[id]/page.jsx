                    ...
                    <div className="max-w-6xl mx-auto px-5 sm:px-8 py-5">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <span
                                    className={
                                        "px-2.5 py-1 rounded-full text-xs font-semibold " + (status === "DRAFT" ? "bg-amber-50 text-amber-700" : "bg-emerald-50 text-emerald-700")
                                    }
                                >
                                    {status}
                                </span>
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <Section icon={User} title="Data Diri">
                                    <DataDiri
                                        ...
                                        setUmur={setUmur}
                                        tgllahir={tgllahir || (kandidatList.tgllahir ? kandidatList.tgllahir.split("T")[0] : "")}
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
                                    ...
                                    <div className="p-4 bg-slate-100">
                                        <DocumentPreview title="KTP" icon={IdCard} url={ktpFile ? URL.createObjectURL(ktpFile) : kandidatList.ktpUrl} type="image" />
