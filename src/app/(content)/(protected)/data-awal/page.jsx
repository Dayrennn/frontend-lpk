...
import { useLazyGetDownloadKandidatFileQuery, useSeeAllKandidatAwalQuery } from "@/hooks/api/kandidatSliceAPI";
                        ...
                        <tbody className="divide-y divide-slate-100">
                            ...
                            {kandidatList.map((k) => (
                                <tr key={k.id} className="hover:bg-slate-50/60 align-top">
                                    ...
                                    <td className="px-5 py-3.5 text-slate-500 capitalize whitespace-nowrap">{k.tujuan}</td>
                                    ...
                                    <td className="px-5 py-3.5 text-slate-500 whitespace-nowrap">{formatTanggalSimpel(k.createdAt)}</td>

                                    <td className="px-5 py-3.5 text-right">
                                        <span className="inline-block max-w-[12rem] truncate px-2.5 py-1 rounded-md text-xs text-slate-700 bg-slate-50" title={k.keterangan}>
                                            {k.keterangan || "-"}
                                        </span>
                                    </td>
